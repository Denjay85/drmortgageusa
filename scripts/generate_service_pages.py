      ...
      <section class="section" id="greater-orlando-va-service-area">
        <div class="section-grid">
          ...
          <article class="section-card">
            ...
            <p class="source-note"><strong>Third-party profile evidence:</strong> Dennis's indexable Experience.com profile identifies him as a Mortgage Broker in Lake Mary, explicitly lists VA Home Loan among his services, and reports a 5.0 rating from 16 verified reviews. <a href="https://www.experience.com/reviews/dennis-14873595">View the Experience.com profile.</a></p>
          </article>
        </div>
      </section>
"""
